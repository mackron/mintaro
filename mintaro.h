...
// NOTES
// =====
// - This embeds miniaudio for audio. See https://github.com/dr-soft/miniaudio for more information.
...
///////////////////////////////////////////////////////////////////////////////
//
// BEGIN MINIAUDIO HEADER SECTTION
//
///////////////////////////////////////////////////////////////////////////////
...
mo_uint32 mo_sound__read_and_accumulate_frames(mo_sound* pSound, float linearVolume, mo_uint32 frameCount, mo_int16* pFrames)
{
    ...
    mo_assert(pSound->pContext->playbackDevice2.playback.channels <= 2);
    ...
    if (pSource->type == mo_sound_source_type_raw)
    {
        ...
        const mo_uint32 deviceChannels = pSound->pContext->playbackDevice2.playback.channels;
        while (frameCount > 0) {
...
void mo_on_data_callback__miniaudio(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount)
{
    ...
    mo_int16* pFramesS16 = (ma_int16*)pOutput;
    ...
    mo_zero_memory(pOutput, frameCount * pDevice->playback.channels * sizeof(mo_int16));
...
mo_result mo_init_audio(mo_context* pContext)
{
    ...
    config.playback.channels = pContext->profile.audioChannels;
    config.sampleRate        = pContext->profile.audioSampleRate;
    config.dataCallback      = mo_on_data_callback__miniaudio;
    config.pUserData         = pContext;
    resultMA = ma_device_init_ex(NULL, 0, &contextConfig, &config, &pContext->playbackDevice2);
    ...
    ma_device_start(&pContext->playbackDevice2);
...
void mo_uninit_audio(mo_context* pContext)
{
    ...
    ma_device_uninit(&pContext->playbackDevice2);
}
